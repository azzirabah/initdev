...
if [ $# == 0 ]; then 
	...
	exit 1
		...
		if [ $1 == "-help" ]; then
			echo "help"
			echo "- Name : initdev vous permet d'initialiser un environement de votre projet."
			echo "- Syntax : initdev nom_projet [-GPL | -MIT] [-C | -CPP | -C++ | -Py | -Latex | -BEAMER] [-git]."
			echo 
			echo "- args :"
			...
			echo "	-git : Initialiser un depot git et ajouter un filtre pour git."
			echo 
			echo "- author : AZZI Rabah azzirabah95@gmail.com"
			exit 0
		fi
elif [ $# == 2 ]; then
	key2=$2
